...
const SubmitButton = ({ isLoading = false, success = null, isDisabled = false, ...rest }) => {
  ...
  return (
    <button
      ...
      css={[
        success === true && tw`transition-colors delay-700 bg-green-600 hover:bg-green-500 focus:ring-green-500`,
        success === false && tw`transition-colors delay-700 bg-red-500 hover:bg-red-500 focus:ring-red-500`,
        isDisabled &&
          tw`transition-colors delay-700 bg-gray-500 cursor-not-allowed hover:bg-gray-400 focus:ring-red-400`,
      ]}
      {...rest}
    >
      {getLabel()}
